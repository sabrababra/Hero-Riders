        ...
        <div>
            <div className='lg:w-10/12 mx-auto mt-0 lg:mt-[-100px]'>
                <div className='flex flex-col lg:flex-row justify-center'>
                    ...
                    <div className="card lg:w-96 bg-primary text-primary-content rounded-none shadow-lg">
                        <div className="card-body text-center">
                            <h1 className='text-3xl my-5 text-center'>Open Time</h1>
                    ...
                    <div className="card lg:w-96 lg:scale-110 z-10 bg-primary-focus text-primary-content rounded-none shadow-lg">
                        <div className="card-body text-center">
